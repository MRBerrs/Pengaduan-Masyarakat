    ...
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                @endif
                <div class="card mb-3">Report Here!</div>
                <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <textarea name="isi_laporan" placeholder="Report Here!" class="form-control"
                            rows="4">{{ old('isi_laporan') }}</textarea>
                    </div>
                    <div class="form-group">
                        <input type="file" name="foto" class="form-control">
                    </div>
                    <button type="submit" class="btn btn-custom mt-2">Send Report</button>
                </form>
            </div>
        </div>
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <p class="italic mb-0">Verified</p>
                            <div class="text-center">
                                {{ $hitung[0] }}
                            </div>
                        </div>
                        <div class="col">
                            <p class="italic mb-0">Process</p>
                            <div class="text-center">
                                {{ $hitung[1] }}
                            </div>
                        </div>
                        <div class="col">
                            <p class="italic mb-0">Done!</p>
                            <div class="text-center">
                                {{ $hitung[2] }}
                            </div>
                        </div>
